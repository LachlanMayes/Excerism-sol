...
def value_of_ace(card_one, card_two):
    ...
    # If adding 11 stays within 21, return 11
...
def is_blackjack(card_one, card_two):
    ...
    # Check if one is an Ace and the other is a ten-card
    condition_1 = (card_one == 'A' and card_two in tens)
    condition_2 = (card_two == 'A' and card_one in tens)
